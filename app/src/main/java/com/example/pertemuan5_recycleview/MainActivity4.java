...
public class MainActivity4 extends AppCompatActivity {
    ...
    private @NonNull ActivityMain4Binding binding;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(MainActivity4.this, "Data  Inserted", Toast.LENGTH_SHORT).show(); binding.edtname.setText("");
        ...
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity4.this, DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(MainActivity4.this, "Update  Succesfully", Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(MainActivity4.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
